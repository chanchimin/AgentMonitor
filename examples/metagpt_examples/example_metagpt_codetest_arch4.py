...
Your code:
    ...
    async def run(self, context: str):
        ...
        set_global_code(str(code_text)) # in arch4 also submit because turn 1
...
async def main(
    task: str = "humaneval",
    output_path: str = "output/arch4/test_3.5_3.5_3.5_3.5",
    # ["llama3_70b_instruct", "llama3_70b_instruct", "llama3_70b_instruct", "llama3_70b_instruct", "llama3_70b_instruct"]
    ...
    for task_line in tqdm(task_data):
        ...
        team = Team()
        simplecoder1 = SimpleCoder(config=llm_configs_dicts[0])
        simplecoder2 = CodeModifier(config=llm_configs_dicts[1])
        simpletester = SimpleTester(config=llm_configs_dicts[2])
    ...
    # calculate success rate, this is the total results of turn1 on 45 tasks, turn2 on 45 tasks, turn3 and so on.
